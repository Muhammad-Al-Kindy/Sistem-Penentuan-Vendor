...
class SmartController extends Controller
{
    ...
    {
        $materials = Material::all(); // tetap ditampilkan
        $vendors = Vendor::all();
        ...
        foreach ($vendors as $vendor) {
            ...
            $poList = DB::table('purchase_orders')->where('vendorId', $vendor->idVendor)->pluck('idPurchaseOrder');
        ...
        // Buat ranking dan scoredVendors
