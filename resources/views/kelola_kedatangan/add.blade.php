...
<div class="max-w-7xl mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Form Tambah Kedatangan</h1>
    <form action="#" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" class="w-full border border-gray-300 rounded px-4 py-2" placeholder="Nama Barang">
        </div>
        <div>
