    ...
    <form action="{{ route('kedatangan.update', $goods_receipt->idGoodsReceipt) }}" method="POST" data-update-form>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
            ...
            <div>
                ...
                <input type="date" name="tanggal_dok" id="tanggal_dok" class="w-full border border-gray-300 rounded px-4 py-2"
            ...
            <div>
                ...
                <input type="date" name="tanggal_terima" id="tanggal_terima" class="w-full border border-gray-300 rounded px-4 py-2"
            ...
            <div>
                ...
                <select name="purchase_order_id" id="purchase_order_id" class="w-full border border-gray-300 rounded px-4 py-2" required>
            ...
            <div>
                ...
                <input type="text" name="no_surat_jalan" id="no_surat_jalan" class="w-full border border-gray-300 rounded px-4 py-2"
